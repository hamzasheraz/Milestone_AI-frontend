...
import { Loader2, Upload, CheckCircle, FileAudio, Wand2, ImageIcon } from 'lucide-react'
      ...
      <Card className="w-full max-w-4xl bg-white dark:bg-gray-800 shadow-2xl">
        ...
        <CardContent className="space-y-6 p-6">
          <div className="flex items-center justify-center w-full">
            <label htmlFor="dropzone-file" className="flex flex-col items-center justify-center w-full h-64 border-2 border-purple-300 border-dashed rounded-lg cursor-pointer bg-purple-50 dark:bg-purple-900 hover:bg-purple-100 dark:hover:bg-purple-800 transition-all duration-300 group">
              <div className="flex flex-col items-center justify-center pt-5 pb-6">
                <Upload className="w-12 h-12 mb-3 text-purple-500 group-hover:text-purple-600 transition-colors duration-300" />
          ...
          {uploading && (
            <div className="space-y-2">
              <Progress value={uploadProgress} className="w-full h-2 bg-purple-200 dark:bg-purple-700">
                <div
          ...
          <AnimatePresence>
            {summary && (
              ...
              >
                <h3 className="text-xl font-semibold text-purple-800 dark:text-purple-300 mb-4">Meeting Summary</h3>
                <div
                ...
                <div className="mb-4">
                  <h4 className="text-lg font-semibold text-purple-800 dark:text-purple-300 mb-2">Emotion</h4>
